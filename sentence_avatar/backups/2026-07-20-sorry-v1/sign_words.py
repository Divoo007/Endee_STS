...
# (Probe-solved, radius ~3 cm, centre hand ~(0.0, 1.35, 0.17)). Getting the fist LOW
...
# shipped ~19deg-off camera the back of the fist faces the viewer with the palm on
# the chest, the correct SORRY orientation (verified in PoseLab front + shipped view).
...
# Four quadrature points of the rub circle (Probe-verified hand positions in comments):
_SORRY_TOP = _sorry_key(-5, 80, 57)   # 12 o'clock  hand (0.004, 1.379, 0.175)
_SORRY_R   = _sorry_key(2, 88, 50)    #  3 o'clock  hand (0.025, 1.349, 0.172)
_SORRY_BOT = _sorry_key(9, 82, 57)    #  6 o'clock  hand (-0.008, 1.321, 0.164)
_SORRY_L   = _sorry_key(2, 72, 64)    #  9 o'clock  hand (-0.032, 1.349, 0.171)
# Rise into the circle at the BOTTOM (the hand comes up from the hip), then trace two
# slow loops BOTTOM -> LEFT -> TOP -> RIGHT -> BOTTOM (counter-clockwise on screen),
# hold, and return. The sad emotion slows the whole word (~1.45x), so the rub reads
# as deliberate and heavy.
SORRY_SIGN = [
    {"t": 0.0, **NEUTRAL_POSE},
    {"t": 0.16, **NEUTRAL_POSE, **_SORRY_BOT},   # rise, form the fist, arrive at the chest
    {"t": 0.25, **NEUTRAL_POSE, **_SORRY_L},     # circle 1
    {"t": 0.34, **NEUTRAL_POSE, **_SORRY_TOP},
    {"t": 0.43, **NEUTRAL_POSE, **_SORRY_R},
    {"t": 0.52, **NEUTRAL_POSE, **_SORRY_BOT},
    {"t": 0.61, **NEUTRAL_POSE, **_SORRY_L},     # circle 2
    {"t": 0.70, **NEUTRAL_POSE, **_SORRY_TOP},
    {"t": 0.79, **NEUTRAL_POSE, **_SORRY_R},
    {"t": 0.88, **NEUTRAL_POSE, **_SORRY_BOT},   # close the loop, brief hold
    {"t": 1.0, **NEUTRAL_POSE},
]
